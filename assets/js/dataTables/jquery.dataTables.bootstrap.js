...
$.extend( true, $.fn.dataTable.defaults, {
	"sDom":
		"t"+
		"<'row dataTables_footer'<'col-xs-6 col-sm-6'li><'col-xs-6'p>>",
	"oLanguage": {
		"sProcessing": "处理中...",
	...
	$.extend( $.fn.dataTableExt.oPagination, {
		"bootstrap": {
			"fnInit": function( oSettings, nPaging, fnDraw ) {
				...
				$(nPaging).append(
					'<ul class="pagination">'+
						'<li class="first disabled"><a href="#"><i class="fa fa-angle-double-left"></i></a></li>'+//first
						...
						'<li class="last disabled"><a href="#"><i class="fa fa-angle-double-right"></i></a></li>'+//last
					'</ul>'
				);
				var els = $('a', nPaging);
			...
			"fnUpdate": function ( oSettings, fnDraw ) {
				...
				for ( i=0, ien=an.length ; i<ien ; i++ ) {
					...
					$('li:gt(0)', an[i]).filter(':not(:first,.next,.prev,:last)').remove();//ACE
