...
(function(global) {
	var Me = this, disabled = false, showIdentify = false, plottingType = null, plottingGraphics = null;
...
var BookMarkTool = {
	...
	init :function(){
		  ...
		  $.post(contextPath+'/common/getMapTag.do',{},function(result){
			 var data = null;
			 ...
			 if(data){
				 ...
				 $(data).each(function(index,ele){
					 ...
					 $(li).on("click",function(){
						  BookMarkTool.position(ele.x,ele.y,ele.level);
					 })
				 	 $("#bookmarks").append(li);
				 });
			 }
	...
	add:function(){
		 ...
		 if(title.Trim()=="")return alert("请输入标签名称!");
		 var obj = new Object();
		 ...
		 $.post(contextPath+'/common/addMapTag.do',obj,function(result){
			 BookMarkTool.init();
			 BookMarkTool.showListPannel();
		 });
		
	},
	remove:function(id,index,ele){
		 $(ele).parent().remove();
		 ...
		 var obj = new Object();
		 obj.id = id ;
		 $.post(contextPath+'/common/remoeveMapTag.do',obj,function(result){
			 BookMarkTool.init();
			 BookMarkTool.showListPannel();
		 });
	},
